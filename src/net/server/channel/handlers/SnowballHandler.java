...
public final class SnowballHandler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		...
		final MapleSnowball othersnowball = map
				.getSnowball(chr.getTeam() == 0 ? (byte) 1 : 0);
		final int what = slea.readByte();
		// slea.skip(4);

		if ((snowball == null) || (othersnowball == null)
				|| (snowball.getSnowmanHP() == 0)) {
			return;
		}

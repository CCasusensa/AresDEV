...
public class AdminChatHandler extends AbstractMaplePacketHandler {
	...
	public final void handlePacket(SeekableLittleEndianAccessor slea,
		...
		// not saving slides...
		final byte[] packet = MaplePacketCreator.serverNotice(slea.readByte(),
				slea.readMapleAsciiString());// maybe I should make a check for
												// the slea.readByte()... but I
												// just hope gm's don't fuck
												// things up :)
		switch (mode) {

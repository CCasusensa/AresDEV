...
public class GenericLittleEndianWriter implements LittleEndianWriter {
	...
	public void writeLong(long l) {
		this.bos.writeByte((byte) (l & 0xFF));
		this.bos.writeByte((byte) ((l >>> 8) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 16) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 24) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 32) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 40) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 48) & 0xFF));
		this.bos.writeByte((byte) ((l >>> 56) & 0xFF));
	}

...
public class FilePrinter {
	...
	public static final String ACCOUNT_STUCK = "accountStuck.txt",
			...
			ADD_PLAYER = "addPlayer.txt", MAPLE_MAP = "mapleMap.txt",
			ERROR38 = "error38.txt", PACKET_LOG = "log.txt",
			EXCEPTION = "exceptions.txt", PACKET_HANDLER = "PacketHandler/",
			PORTAL = "portals/", NPC = "npcs/", INVOCABLE = "invocable/",
			REACTOR = "reactors/", QUEST = "quests/", ITEM = "items/",
			MOB_MOVEMENT = "mobmovement.txt", MAP_SCRIPT = "mapscript/",
			DIRECTION = "directions/", SAVE_CHAR = "saveToDB.txt",
			INSERT_CHAR = "insertCharacter.txt",
			LOAD_CHAR = "loadCharFromDB.txt", SESSION = "sessions.txt";// more
																		// to
																		// come
																		// (maps)

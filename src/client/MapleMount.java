...
public class MapleMount {
	...
	public void increaseTiredness() {
		...
		this.owner.getMap()
				.broadcastMessage(
						MaplePacketCreator.updateMount(this.owner.getId(),
								this, false));
		if (this.tiredness > 99) {
			this.tiredness = 95;
			this.owner.dispelSkill((this.owner.getJobType() * 10000000) + 1004);
		}
	}
	...
	public void startSchedule() {
		this.tirednessSchedule = TimerManager.getInstance().register(
				new Runnable() {
					@Override
					public void run() {
